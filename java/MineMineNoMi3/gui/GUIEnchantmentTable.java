...
import MineMineNoMi3.container.ContainerEnchantmentTable;
import WyPI.WyPI;

@SideOnly(Side.CLIENT)
public class GUIEnchantmentTable extends GuiContainer
{
    private static final ResourceLocation texture = new ResourceLocation(WyPI.apiInstance.getParentMod().getParentModID(), "textures/gui/gui_dial.png");
