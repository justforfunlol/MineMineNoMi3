...
public class ListExtraAttributes
{
	...
	public static AbilityAttribute GOMUGOMUNOELEPHANTGATLING = new AbilityAttribute("Gomu Gomu no Elephant Gatling").setProjectileTicks(5).setProjectileTicks(40).setProjectileModel(new ModelFist()).setProjectileTexture("gomugomunoelephantgun").setProjectileSize(15, 15, 13).setModelOffsets(-1, 5, 0).setProjectileDamage(20).setProjectileMoveThroughBlocks(true).setProjectileNewExplosion(2);
	public static AbilityAttribute GOMUGOMUNOKONGORGAN = new AbilityAttribute("Gomu Gomu no Kong Organ").setProjectileTicks(5).setProjectileTicks(30).setProjectileModel(new ModelFist()).setProjectileTexture("gomugomunokonggun").setProjectileSize(15, 15, 13).setModelOffsets(-1, 5, 0).setProjectileDamage(30).setProjectileMoveThroughBlocks(true).setProjectileNewExplosion(2);
	...
	public static AbilityAttribute VOLTVARI20MILLION = new AbilityAttribute("20 Million Volt Vari").setProjectileTicks(20).setProjectileModel(new ModelSphere()).setProjectileModel(new ModelSphere()).setProjectileSize(1.5, 1.5, 1.5).setProjectileDamage(5).setProjectileColor("7CB9E8");
	public static AbilityAttribute VOLTVARI60MILLION = new AbilityAttribute("60 Million Volt Vari").setProjectileTicks(30).setProjectileModel(new ModelSphere()).setProjectileModel(new ModelSphere()).setProjectileSize(3.5, 3.5, 3.5).setProjectileDamage(7).setProjectileColor("6bb0e5");
	public static AbilityAttribute VOLTVARI200MILLION = new AbilityAttribute("200 Million Volt Vari").setProjectileTicks(50).setProjectileModel(new ModelSphere()).setProjectileModel(new ModelSphere()).setProjectileSize(5, 5, 5).setProjectileDamage(10).setAbilityExplosion(3).setProjectileColor("3170a0");
