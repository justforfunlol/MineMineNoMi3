...
public class GUICC extends GuiScreen
{
	...
	public void drawScreen(int x, int y, float f)
	{
		...
		if(!props.getFaction().equals("N/A"))
			mc.fontRenderer.drawStringWithShadow(props.getFaction(), posX + 250, posY + 59, WyHelper.hexToRGB("FFFFFF").getRGB());
		
		if(!props.getRace().equals("N/A"))
			mc.fontRenderer.drawStringWithShadow(props.getRace(), posX + 250, posY + 79, WyHelper.hexToRGB("FFFFFF").getRGB());

		if(!props.getJob().equals("N/A"))
			mc.fontRenderer.drawStringWithShadow(props.getJob(), posX + 250, posY + 99, WyHelper.hexToRGB("FFFFFF").getRGB());
