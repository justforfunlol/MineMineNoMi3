...
public class ModelPhoenixFull extends ModelZoanMorph
{
	...
	public ModelPhoenixFull()
	{
		...
		this.Tails22.setRotationPoint(-0.2F, 0.0F, 8.2F);
		this.Tails22.addBox(-2.0F, 0.0F, 0.0F, 2, 0, 7, 0.0F);
		this.setRotateAngle(Tails22, 0.0F, 0.3490658503988659F, 0.0F);
		...
		this.Tails2.addBox(-2.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
		this.setRotateAngle(Tails2, 0.0F, -0.2617993877991494F, 0.0F);
		...
		this.Tails11 = new ModelRenderer(this, 105, 55);
		this.Tails11.setRotationPoint(0.2F, 0.0F, 6.3F);
		this.Tails11.addBox(0.0F, 0.0F, 0.0F, 2, 0, 9, 0.0F);
		this.setRotateAngle(Tails11, 0.0F, -0.3490658503988659F, 0.0F);
		...
		this.RightWing2.addBox(-27.0F, 0.5F, 0.0F, 15, 0, 12, 0.0F);
		...
		this.Fire = new ModelRenderer(this, 78, -12);
		this.Fire.setRotationPoint(0.0F, -1.0F, -16.0F);
		this.Fire.addBox(0.0F, 0.0F, 0.0F, 0, 3, 25, 0.0F);
		...
		this.LeftWing2.addBox(12.7F, 0.5F, 0.0F, 15, 0, 12, 0.0F);
		this.setRotateAngle(LeftWing2, 0.0F, 0.06981317007977318F, 0.0F);
		...
		this.Tails1 = new ModelRenderer(this, 102, 57);
		this.Tails1.setRotationPoint(0.0F, 3.0F, 11.0F);
		this.Tails1.addBox(0.0F, 0.0F, 0.0F, 2, 0, 7, 0.0F);
		this.setRotateAngle(Tails1, 0.0F, 0.2617993877991494F, 0.0F);
    ...
    {  
	    double[] animationFlyMovement = new double[]
				{0, 5, 10, 15, 20, 15, 10, 5, 0, -5, -10, -15, -20, -15, -10, -5};       	    
	
        int cycleIndexFlyWing = (int) ((ent.ticksExisted * 1.2) % animationFlyMovement.length);

        if(!Minecraft.getMinecraft().isGamePaused())
	    {
    		LeftArm1.rotateAngleZ = (float) degToRad(animationFlyMovement[cycleIndexFlyWing]);
    		RightArm1.rotateAngleZ = (float) degToRad(animationFlyMovement[cycleIndexFlyWing]) * -1;
	    }
    }
