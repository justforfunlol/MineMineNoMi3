...
public class ParticleTaskCharge1 extends TimerTask
{
	...
	public ParticleTaskCharge1(EntityLivingBase player, double posX, double posY, double posZ, String fxName, double radius, int density, double opening, double height)
	{
		this.player = player;
		this.fxName = fxName;
		this.radius = radius;
